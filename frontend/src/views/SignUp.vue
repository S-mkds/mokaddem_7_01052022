...
<main class="form-signin">
  <form @submit.prevent="signUpUser">
    ...
    <div class="form-floating">
      <input type="password" class="form-control"  id="password" placeholder="Password"  v-model="password"  pattern="[A-Za-z0-9]{4,25}" title="Le mot de passe doit contenir au moins 4 à 25 caractères, il est conseillé d'utiliser des majuscules ou des chiffres." required>
